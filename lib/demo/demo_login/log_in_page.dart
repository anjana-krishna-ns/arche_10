...
class AuthPageee extends StatefulWidget {
  const AuthPageee({Key? key}) : super(key: key);

  @override
  _AuthPageeeState createState() => _AuthPageeeState();
}
class _AuthPageeeState extends State<AuthPageee> {
  String?fname;
  String?lname;
  String?email;
  int?number;
  ...
  writedata() async {
    ...
    var Url = "https://arche-test-default-rtdb.firebaseio.com//" +
        "archetest.json";
    try {
      final response = await http.post(Uri.parse(Url),
          body: json.encode({"fname": fname,"lname":lname,"email":email,"number":number,"password":password,"cpassword":cpassword}));
    } catch (error) {
      throw error;
    }
  }
